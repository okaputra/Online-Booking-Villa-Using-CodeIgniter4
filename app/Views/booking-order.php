      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li class="active" style="padding-right: 5px"><a href="/checklist" style="color:black;">MY BOOKING</a></li>
            <?php if(session('islogin')==true) : ?>
              ...
              <div class="container mt-5 px-2">
                    ...
                    <div class="mb-2 d-flex justify-content-between align-items-center">
                        ...
                        <thead>
                            ...
                            <th scope="col" width="20%">Villa Name</th>
                    ...
                    ?>
                        ...
                        <td><a style="color:#59abe3;" href="/detail/<?= $villa['id']; ?>"><?= $villa['villa_name']; ?></a></td>
                        <?php if($row['status']=='Waiting'||$row['status']=='Rejected') : ?>
                            <td><i class="fa fa-dot-circle-o text-danger"> <?= $row['status']; ?></td>
                        <?php else : ?>
                            <td><i class="fa fa-check-circle-o green"> <?= $row['status']; ?></td>
                        <?php endif; ?>
                        <td class="text-end"><span class="fw-bolder"><?= number_to_currency($row['total_price'], 'IDR', 'en_DB'); ?></span></td>
                        </tr>
                    <?php
                    }
                    ?>
